...
def get_invoices(filters):
	...
	return frappe.db.sql("""select nome_mesa as "Mesa N:data:200",hora_atendimento as "Hora atendida:datetime:200",status_atendimento as "Status:data:200",total_servicos as "Total:currency:120",nome_cliente as "Cliente:data:150" FROM tabBAR_RESTAURANTE WHERE status_atendimento ='Fechado' ORDER BY nome_mesa""", as_dict=1)
